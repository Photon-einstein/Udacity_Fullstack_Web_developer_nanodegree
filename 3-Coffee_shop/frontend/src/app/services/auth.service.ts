...
export class AuthService {
  ...
  build_logout_link(returnTo: string) {
    return `https://${this.url}.auth0.com/logout?client_id=${this.clientId}&returnTo=${returnTo}`;
  }
  ...
  logout() {
    ...
    window.location.href = this.build_logout_link(returnTo);
  }
